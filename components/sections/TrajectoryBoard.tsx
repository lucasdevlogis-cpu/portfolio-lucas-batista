...
export function TrajectoryBoard() {
  ...
  return (
    ...
    >
      <div className="grid gap-8 lg:grid-cols-[0.45fr_0.55fr] xl:grid-cols-[0.42fr_0.58fr]">
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            <PremiumCard className="h-full p-6 lg:p-8">
              ...
              <div className="relative mt-8 space-y-8">
                <div className="absolute left-[1.35rem] top-4 bottom-4 hidden w-px bg-gradient-to-b from-accent via-primary to-transparent sm:block" aria-hidden />
                {experienceSignals.trajetoria.map((signal, index) => {
                  ...
                  return (
                    <div key={signal.titulo} className="relative grid grid-cols-[3.5rem_1fr] gap-5 sm:grid-cols-[4.5rem_1fr]">
                      <div className="relative z-10 flex size-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary/80 text-white shadow-md sm:size-13">
          ...
          >
            <PremiumCard tone="dark" className="bg-surface-dark p-6 lg:p-8 text-white">
              <div className="flex items-center gap-3">
                ...
                {latestExperiences.map((exp, index) => {
                  ...
                  return (
                    <article
                      ...
                      className={cn(
                        "group grid gap-5 rounded-xl border p-6 transition-all duration-normal ease-editorial lg:grid-cols-[0.8fr_1.2fr]",
                        isCurrent
