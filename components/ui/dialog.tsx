  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-sm border border-border bg-popover p-4 text-sm text-popover-foreground outline-none",
          ...
          <DialogPrimitive.Close
            render={
              <Button
                variant="ghost"
                size="icon"
                className="absolute right-3 top-3 border border-border hover:border-primary hover:text-primary"
              />
            }
          >
